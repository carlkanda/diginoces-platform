...
- Sprint 8 seating exports generate CSV metadata and storage-path placeholders without inlining CSV content in `seating_export_files`; direct Canva API integration and print partner workflow are intentionally out of scope.
