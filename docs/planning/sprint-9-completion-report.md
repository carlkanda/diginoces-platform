...
- The Sprint 9 migration was not pushed to the linked dev project from this feature branch. Apply pending migrations after merge as the team has done for earlier sprints.
...
- The linked dev database may lag behind `main`; dry-run evidence shows Sprint 8 and Sprint 9 pending together.
...
- Linked dev DB QA requires applying pending Sprint 8 and Sprint 9 migrations after merge.
...
- Proceed with Sprint 10 contracts, pricing, and payment controls only after Sprint 9 is reviewed, merged, and its migration is applied to the dev database.
